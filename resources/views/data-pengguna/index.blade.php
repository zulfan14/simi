...
@section('content')
                ...
                success: function(response) {
                    ...
                    $.each(response.data, function(key, value) {
                        ...
                        <tr class="pengguna-row" id="index_${value.id}">
                            ...
                            <td>
                                <a href="javascript:void(0)" id="button_edit_pengguna" data-id="${value.id}" class="mb-2 btn btn-icon btn-warning btn-lg"><i class="far fa-edit"></i> </a>
                                <a href="javascript:void(0)" id="button_hapus_pengguna" data-id="${value.id}" class="mb-2 btn btn-icon btn-danger btn-lg"><i class="fas fa-trash"></i> </a>
                            </td>
                        </tr>
                        `;
    ...
    <script>
        ...
        $('#store').click(function(e) {
            ...
            formData.append('direktorat_id', direktorat_id);
    ...
    <script>
        ...
        $('body').on('click', '#button_edit_pengguna', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#edit_direktorat_id').val(response.data.direktorat_id);
        ...
        $('#update').click(function(e) {
            ...
            let direktorat_id = $('#edit_direktorat_id').val();
            let token = $("meta[name='csrf-token']").attr("content");
            console.log({direktorat_id});

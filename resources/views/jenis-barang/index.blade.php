...
<div class="dashboard-first">
    <div class="container">
        <div class="row">
        <h1 style="margin-top: 10px;">Data Jenis Barang</h1>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                <tr class="barang-row" id="index_${value.id}">
                    ...
                    <td>
                        <a href="javascript:void(0)" id="button_edit_jenis_barang" data-id="${value.id}" class="mb-2 btn btn-icon btn-warning btn-lg"><i class="far fa-edit"></i> </a>
                        <a href="javascript:void(0)" id="button_hapus_jenis_barang" data-id="${value.id}" class="mb-2 btn btn-icon btn-danger btn-lg"><i class="fas fa-trash"></i> </a>
                    </td>
                </tr>
            `;

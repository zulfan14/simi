...
class ManajemenUserController extends Controller
{
    ...
    {
        $penggunas = User::with(['direktorat','role'])->get();
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'direktorat_id.required'  => 'Tentukan Dirrekotrat !',
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'email.required'    => 'Form Email Wajib Di isi !',
            'role_id.required'  => 'Tentukan Role/Hak Akses !',
            'direktorat_id.required'  => 'Tentukan Direktorat !',
        ]);
    ...
    public function getDirektorat()
    {
        ...
        return response()->json($direktorats);
    }
}
